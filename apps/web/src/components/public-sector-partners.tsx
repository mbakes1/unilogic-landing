...
export default function PublicSectorPartners() {
    return (
        <section id="about" className="bg-background overflow-hidden py-12 sm:py-16">
            <div className="group relative m-auto max-w-5xl px-4 sm:px-6">
                <div className="flex flex-col items-center">
                    ...
                    <div className="w-full relative py-4">
                        ...
                        <ProgressiveBlur
                            className="pointer-events-none absolute left-0 top-0 h-full w-10 sm:w-16 md:w-20"
                            direction="left"
                            blurIntensity={1}
                        />
                        <ProgressiveBlur
                            className="pointer-events-none absolute right-0 top-0 h-full w-10 sm:w-16 md:w-20"
                            direction="right"
                            blurIntensity={1}
                        />
                    </div>
